# @veecode-platform/plugin-scaffolder-backend
...
- 8872cc735d: Fixed a bug in plugin-scaffolder-backend where it ignores the skip migration database options.
  ...
  import { DatabaseTaskStore } from '@veecode-platform/plugin-scaffolder-backend';
...
- f9c7bdd899: **BREAKING**:
  ...
  - Removed the `createFetchCookiecutterAction` export, please use the `@veecode-platform/plugin-scaffolder-backend-module-cookiecutter` package explicitly (see [its README](https://github.com/backstage/backstage/tree/master/plugins/scaffolder-backend-module-cookiecutter) for installation instructions).
...
- Updated dependencies
  ...
  - @veecode-platform/plugin-scaffolder-backend-module-cookiecutter@0.2.3
...
- 9d9b2bab47: - **BREAKING** - Removed the re-export of types `TaskSpec` `TaskSpecV1Beta2` and `TaskSpecV1Beta3` these should now be import from `@backstage/plugin-scaffolder-common` directly.
  - **BREAKING** - Removed the `observe` method from the `TaskBroker` interface, this has now been replaced with an `Observable` implementation under `event# @veecode-platform/plugin-scaffolder-backend.
...
- 6981ac4ad2: - **DEPRECATED** - The `containerRunner` option passed to `createBuiltinActions` has now been deprecated.
  ...
  The `fetch:cookiecutter` action will soon be removed from the default list of actions that are provided out of the box from the scaffolder plugin. It will still be supported, and maintained by the community, so you can install the package (`@veecode-platform/plugin-scaffolder-backend-module-cookiecutter`) and pass it in as a custom action. Or you can migrate your templates to use [`fetch:template`](https://backstage.io/docs/features/software-templates/builtin-actions#migrating-from-fetchcookiecutter-to-fetchtemplate) with the `cookiecutterCompat` option.
...
- Updated dependencies
  ...
  - @veecode-platform/plugin-scaffolder-backend-module-cookiecutter@0.2.2
...
- Updated dependencies
  ...
  - @veecode-platform/plugin-scaffolder-backend-module-cookiecutter@0.2.1
...
- Updated dependencies
  ...
  - @veecode-platform/plugin-scaffolder-backend-module-cookiecutter@0.2.0
...
- Updated dependencies
  ...
  - @veecode-platform/plugin-scaffolder-backend-module-cookiecutter@0.1.11
...
- Updated dependencies
  ...
  - @veecode-platform/plugin-scaffolder-backend-module-cookiecutter@0.1.11-next.0
...
- Updated dependencies
  ...
  - @veecode-platform/plugin-scaffolder-backend-module-cookiecutter@0.1.10
...
- Updated dependencies
  ...
  - @veecode-platform/plugin-scaffolder-backend-module-cookiecutter@0.1.10-next.1
...
- Updated dependencies
  ...
  - @veecode-platform/plugin-scaffolder-backend-module-cookiecutter@0.1.10-next.0
...
- Updated dependencies
  ...
  - @veecode-platform/plugin-scaffolder-backend-module-cookiecutter@0.1.9
...
- Updated dependencies
  ...
  - @veecode-platform/plugin-scaffolder-backend-module-cookiecutter@0.1.9-next.0
...
- Updated dependencies
  ...
  - @veecode-platform/plugin-scaffolder-backend-module-cookiecutter@0.1.8
...
- Updated dependencies
  ...
  - @veecode-platform/plugin-scaffolder-backend-module-cookiecutter@0.1.7
...
- Updated dependencies
  ...
  - @veecode-platform/plugin-scaffolder-backend-module-cookiecutter@0.1.6
...
- Updated dependencies
  ...
  - @veecode-platform/plugin-scaffolder-backend-module-cookiecutter@0.1.5
...
- Updated dependencies
  ...
  - @veecode-platform/plugin-scaffolder-backend-module-cookiecutter@0.1.4
...
- Updated dependencies
  ...
  - @veecode-platform/plugin-scaffolder-backend-module-cookiecutter@0.1.3
...
- Updated dependencies
  ...
  - @veecode-platform/plugin-scaffolder-backend-module-cookiecutter@0.1.2
...
- Updated dependencies
  ...
  - @veecode-platform/plugin-scaffolder-backend-module-cookiecutter@0.1.1
...
- 60e830222: Support for `Template` kinds with version `backstage.io/v1alpha1` has now been removed. This means that the old method of running templates with `Preparers`, `Templaters` and `Publishers` has also been removed. If you had any logic in these abstractions, they should now be moved to `actions` instead, and you can find out more about those in the [documentation](https://backstage.io/docs/features/software-templates/writing-custom-actions)
  ...
  -   Publishers,
  -   Templaters,
  - } from '@veecode-platform/plugin-scaffolder-backend';
...
- 59166e5ec: `createRouter` of scaffolder backend will now require additional option as `entityClient` which could be generated by `CatalogEntityClient` in `plugin-scaffolder-backend` package. Here is example to generate `entityClient`.
  ...
  ```js
  import { CatalogEntityClient } from '@veecode-platform/plugin-scaffolder-backend';
  import { SingleHostDiscovery } from '@backstage/backend-common';
